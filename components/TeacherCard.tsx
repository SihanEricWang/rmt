  ...
  return (
    <div className="rounded-2xl border bg-white shadow-sm transition hover:shadow-md">
      <div className="flex gap-6 p-6">
        {/* Clickable area */}
        <Link href={`/teachers/${teacher.id}`} className="flex min-w-0 flex-1 gap-6">
          {/* LEFT: rating block */}
        ...
        {/* RIGHT: bookmark (non-interactive placeholder for now) */}
        <div className="flex w-10 shrink-0 items-start justify-end">
          <span
            aria-label="Bookmark (coming soon)"
            className="inline-flex rounded-lg p-2 opacity-70"
